...
def test_classification_pure_neural_net_vs_sklearn():
    ...
    X, y = make_classification(n_samples=1000, weights=[.1, .9])
    ...
    eenn_report = eval_utils.classification_report(
        y_true=y_test, 
        y_pred=eenn_y_pred,
        y_score=eenn_y_score)
    ...
    sk_report = eval_utils.classification_report(
        y_true=y_test,
        y_pred=sk_y_pred,
        y_score=sk_y_score)
